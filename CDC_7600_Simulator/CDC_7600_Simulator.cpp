...
bool check_soc(int inst_num)
{
    ...
    if (source_1[inst_num][1] == SB.Floating_Multiply.D1[1]) // Do the #s match?
    {
        if ((source_1[inst_num][0] == 'A' || source_1[inst_num][0] == 'X') && (destination[SB.Floating_Multiply.instruction_num][0] == 'A' || destination[SB.Floating_Multiply.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num])
            {
                return true;
            }
        }
        ...
        {
            if (source_1[inst_num] == SB.Floating_Multiply.D1)
            {
                if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num])
                {
                    return true;
    ...
    if (source_2[inst_num][1] == SB.Floating_Multiply.D1[1]) // Do the #s match?
    {
        if ((source_2[inst_num][0] == 'A' || source_2[inst_num][0] == 'X') && (destination[SB.Floating_Multiply.instruction_num][0] == 'A' || destination[SB.Floating_Multiply.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (source_2[inst_num] == SB.Floating_Multiply.D1)
            {
                if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num])
                {
                    return true;
    ...
    // Normalize unit
    if (source_1[inst_num][1] == SB.Normalize.D1[1]) // Do the #s match?
    {
        if ((source_1[inst_num][0] == 'A' || source_1[inst_num][0] == 'X') && (destination[SB.Normalize.instruction_num][0] == 'A' || destination[SB.Normalize.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Normalize.instruction_num] > issue[inst_num])
            {
                return true;
            }
        }
        ...
        {
            if (source_1[inst_num] == SB.Normalize.D1)
            {
                if (result[SB.Normalize.instruction_num] > issue[inst_num])
                {
                    return true;
    ...
    if (source_2[inst_num][1] == SB.Normalize.D1[1]) // Do the #s match?
    {
        if ((source_2[inst_num][0] == 'A' || source_2[inst_num][0] == 'X') && (destination[SB.Normalize.instruction_num][0] == 'A' || destination[SB.Normalize.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Normalize.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (source_2[inst_num] == SB.Normalize.D1)
            {
                if (result[SB.Normalize.instruction_num] > issue[inst_num])
                {
                    return true;
    ...
    // Pop_count unit
    if (source_1[inst_num][1] == SB.Pop_count.D1[1]) // Do the #s match?
    {
        if ((source_1[inst_num][0] == 'A' || source_1[inst_num][0] == 'X') && (destination[SB.Pop_count.instruction_num][0] == 'A' || destination[SB.Pop_count.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Pop_count.instruction_num] > issue[inst_num])
            {
                return true;
            }
        }
        ...
        {
            if (source_1[inst_num] == SB.Pop_count.D1)
            {
                if (result[SB.Pop_count.instruction_num] > issue[inst_num])
                {
                    return true;
    ...
    if (source_2[inst_num][1] == SB.Pop_count.D1[1]) // Do the #s match?
    {
        if ((source_2[inst_num][0] == 'A' || source_2[inst_num][0] == 'X') && (destination[SB.Pop_count.instruction_num][0] == 'A' || destination[SB.Pop_count.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Pop_count.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (source_2[inst_num] == SB.Pop_count.D1)
            {
                if (result[SB.Pop_count.instruction_num] > issue[inst_num])
                {
                    return true;
    ...
    // Increment unit
    if (source_1[inst_num][1] == SB.Increment.D1[1]) // Do the #s match?
    {
        if ((source_1[inst_num][0] == 'A' || source_1[inst_num][0] == 'X') && (destination[SB.Increment.instruction_num][0] == 'A' || destination[SB.Increment.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Increment.instruction_num] > issue[inst_num])
            {
                return true;
            }
        }
        ...
        {
            if (source_1[inst_num] == SB.Increment.D1)
            {
                if (result[SB.Increment.instruction_num] > issue[inst_num])
                {
                    return true;
    ...
    if (source_2[inst_num][1] == SB.Increment.D1[1]) // Do the #s match?
    {
        if ((source_2[inst_num][0] == 'A' || source_2[inst_num][0] == 'X') && (destination[SB.Increment.instruction_num][0] == 'A' || destination[SB.Increment.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Increment.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (source_2[inst_num] == SB.Increment.D1)
            {
                if (result[SB.Increment.instruction_num] > issue[inst_num])
                {
                    return true;
...
int resolve_soc_conflict(int inst_num)
{
    ...
    if (source_1[inst_num][1] == SB.Floating_Multiply.D1[1]) // Do the #s match?
    {
        if ((source_1[inst_num][0] == 'A' || source_1[inst_num][0] == 'X') && (destination[SB.Floating_Multiply.instruction_num][0] == 'A' || destination[SB.Floating_Multiply.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num] && (result[SB.Floating_Multiply.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Floating_Multiply.instruction_num];
            }
        }
        else if (source_1[inst_num][0] == 'B') // branch instructions modify these registers
        {
    ...
    if (source_1[inst_num][1] == SB.Normalize.D1[1]) // Do the #s match?
    {
        if ((source_1[inst_num][0] == 'A' || source_1[inst_num][0] == 'X') && (destination[SB.Normalize.instruction_num][0] == 'A' || destination[SB.Normalize.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Normalize.instruction_num] > issue[inst_num] && (result[SB.Normalize.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Normalize.instruction_num];
            }
        }
        else if (source_1[inst_num][0] == 'B') // branch instructions modify these registers
        {
    ...
    if (source_1[inst_num][1] == SB.Pop_count.D1[1]) // Do the #s match?
    {
        if ((source_1[inst_num][0] == 'A' || source_1[inst_num][0] == 'X') && (destination[SB.Pop_count.instruction_num][0] == 'A' || destination[SB.Pop_count.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Pop_count.instruction_num] > issue[inst_num] && (result[SB.Pop_count.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Pop_count.instruction_num];
            }
        }
        else if (source_1[inst_num][0] == 'B') // branch instructions modify these registers
        {
    ...
    if (source_1[inst_num][1] == SB.Increment.D1[1]) // Do the #s match?
    {
        if ((source_1[inst_num][0] == 'A' || source_1[inst_num][0] == 'X') && (destination[SB.Increment.instruction_num][0] == 'A' || destination[SB.Increment.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Increment.instruction_num] > issue[inst_num] && (result[SB.Increment.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Increment.instruction_num];
            }
        }
        else if (source_1[inst_num][0] == 'B') // branch instructions modify these registers
        {
...
bool check_toc(int inst_num)
{
    ...
    // Floating_Multiply unit
    if (destination[inst_num][1] == SB.Floating_Multiply.S1[1]) // Do the #s match?
    {
        if ((destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X') && (source_1[SB.Floating_Multiply.instruction_num][0] == 'A' || source_1[SB.Floating_Multiply.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (destination[inst_num] == SB.Floating_Multiply.S1)
            {
                if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num])
                {
                    return true;
        ...
        if ((destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X') && (source_2[SB.Floating_Multiply.instruction_num][0] == 'A' || source_2[SB.Floating_Multiply.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (destination[inst_num] == SB.Floating_Multiply.S2)
            {
                if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num])
                {
                    return true;
    ...
    // Normalize unit
    if (destination[inst_num][1] == SB.Normalize.S1[1]) // Do the #s match?
    {
        if ((destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X') && (source_1[SB.Normalize.instruction_num][0] == 'A' || source_1[SB.Normalize.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Normalize.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (destination[inst_num] == SB.Normalize.S1)
            {
                if (result[SB.Normalize.instruction_num] > issue[inst_num])
                {
                    return true;
        ...
        if ((destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X') && (source_2[SB.Normalize.instruction_num][0] == 'A' || source_2[SB.Normalize.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Normalize.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (destination[inst_num] == SB.Normalize.S2)
            {
                if (result[SB.Normalize.instruction_num] > issue[inst_num])
                {
                    return true;
    ...
    // Pop_count unit
    if (destination[inst_num][1] == SB.Pop_count.S1[1]) // Do the #s match?
    {
        if ((destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X') && (source_1[SB.Pop_count.instruction_num][0] == 'A' || source_1[SB.Pop_count.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Pop_count.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (destination[inst_num] == SB.Pop_count.S1)
            {
                if (result[SB.Pop_count.instruction_num] > issue[inst_num])
                {
                    return true;
        ...
        if ((destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X') && (source_2[SB.Pop_count.instruction_num][0] == 'A' || source_2[SB.Pop_count.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Pop_count.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (destination[inst_num] == SB.Pop_count.S2)
            {
                if (result[SB.Pop_count.instruction_num] > issue[inst_num])
                {
                    return true;
    ...
    // Increment unit
    if (destination[inst_num][1] == SB.Increment.S1[1]) // Do the #s match?
    {
        if ((destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X') && (source_1[SB.Increment.instruction_num][0] == 'A' || source_1[SB.Increment.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Increment.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (destination[inst_num] == SB.Increment.S1)
            {
                if (result[SB.Increment.instruction_num] > issue[inst_num])
                {
                    return true;
        ...
        if ((destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X') && (source_2[SB.Increment.instruction_num][0] == 'A' || source_2[SB.Increment.instruction_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Increment.instruction_num] > issue[inst_num])
            {
                return true;
        ...
        {
            if (destination[inst_num] == SB.Increment.S2)
            {
                if (result[SB.Increment.instruction_num] > issue[inst_num])
                {
                    return true;
...
int resolve_toc_conflict(int inst_num)
{
    ...
    if (destination[inst_num][1] == SB.Floating_Multiply.S1[1]) // Do the #s match?
    {
        if ((source_1[SB.Floating_Multiply.instruction_num][0] == 'A' || source_1[SB.Floating_Multiply.instruction_num][0] == 'X') && (destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num] && (result[SB.Floating_Multiply.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Floating_Multiply.instruction_num];
    ...
    if (destination[inst_num][1] == SB.Floating_Multiply.S2[1]) // Do the #s match?
    {
        if ((source_2[SB.Floating_Multiply.instruction_num][0] == 'A' || source_2[SB.Floating_Multiply.instruction_num][0] == 'X') && (destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Floating_Multiply.instruction_num] > issue[inst_num] && (result[SB.Floating_Multiply.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Floating_Multiply.instruction_num];
    ...
    if (destination[inst_num][1] == SB.Normalize.S1[1]) // Do the #s match?
    {
        if ((source_1[SB.Normalize.instruction_num][0] == 'A' || source_1[SB.Normalize.instruction_num][0] == 'X') && (destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Normalize.instruction_num] > issue[inst_num] && (result[SB.Normalize.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Normalize.instruction_num];
    ...
    if (destination[inst_num][1] == SB.Normalize.S2[1]) // Do the #s match?
    {
        if ((source_2[SB.Normalize.instruction_num][0] == 'A' || source_2[SB.Normalize.instruction_num][0] == 'X') && (destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Normalize.instruction_num] > issue[inst_num] && (result[SB.Normalize.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Normalize.instruction_num];
    ...
    if (destination[inst_num][1] == SB.Pop_count.S1[1]) // Do the #s match?
    {
        if ((source_1[SB.Pop_count.instruction_num][0] == 'A' || source_1[SB.Pop_count.instruction_num][0] == 'X') && (destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Pop_count.instruction_num] > issue[inst_num] && (result[SB.Pop_count.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Pop_count.instruction_num];
    ...
    if (destination[inst_num][1] == SB.Pop_count.S2[1]) // Do the #s match?
    {
        if ((source_2[SB.Pop_count.instruction_num][0] == 'A' || source_2[SB.Pop_count.instruction_num][0] == 'X') && (destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Pop_count.instruction_num] > issue[inst_num] && (result[SB.Pop_count.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Pop_count.instruction_num];
    ...
    if (destination[inst_num][1] == SB.Increment.S1[1]) // Do the #s match?
    {
        if ((source_1[SB.Increment.instruction_num][0] == 'A' || source_1[SB.Increment.instruction_num][0] == 'X') && (destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Increment.instruction_num] > issue[inst_num] && (result[SB.Increment.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Increment.instruction_num];
    ...
    if (destination[inst_num][1] == SB.Increment.S2[1]) // Do the #s match?
    {
        if ((source_2[SB.Increment.instruction_num][0] == 'A' || source_2[SB.Increment.instruction_num][0] == 'X') && (destination[inst_num][0] == 'A' || destination[inst_num][0] == 'X')) // bc these come in pairs
        {
            if (result[SB.Increment.instruction_num] > issue[inst_num] && (result[SB.Increment.instruction_num] > temp_clock))
            {
                temp_clock = result[SB.Increment.instruction_num];
